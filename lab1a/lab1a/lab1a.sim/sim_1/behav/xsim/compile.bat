...
REM
REM Generated by Vivado on Fri Sep 05 12:57:42 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj lab_1a_top_level_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab_1a_top_level_tb_vlog.prj -log xvlog.log
