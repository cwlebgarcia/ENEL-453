...
REM
REM Generated by Vivado on Mon Sep 15 20:05:33 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj lab2_mux2_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab2_mux2_tb_vlog.prj -log xvlog.log
