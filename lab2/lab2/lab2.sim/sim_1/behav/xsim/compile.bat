...
REM
REM Generated by Vivado on Fri Sep 19 14:31:01 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj lab_2_top_level_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab_2_top_level_tb_vlog.prj -log xvlog.log
